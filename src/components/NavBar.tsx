      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            <span className="text-xl font-bold text-tech-blue">Electro<span className="text-tech-purple">Nexus</span></span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link to="/products" className="text-foreground hover:text-tech-purple transition-colors">
              All Products
            </Link>
            <Link to="/categories" className="text-foreground hover:text-tech-purple transition-colors">
              Categories
            </Link>
            <Link to="/deals" className="text-foreground hover:text-tech-purple transition-colors">
              Deals
            </Link>
          </nav>
        ...
        <div className="fixed inset-0 z-50 bg-background pt-16">
          <div className="container mx-auto px-4 py-4">
            ...
            <nav className="flex flex-col space-y-4">
              <Link to="/products" className="py-2 text-lg" onClick={() => setIsMenuOpen(false)}>
                All Products
              </Link>
              <Link to="/categories" className="py-2 text-lg" onClick={() => setIsMenuOpen(false)}>
                Categories
              </Link>
              <Link to="/deals" className="py-2 text-lg" onClick={() => setIsMenuOpen(false)}>
                Deals
              </Link>
              
              <div className="h-px bg-border my-2"></div>
              
              <Link to="/wishlist" className="py-2 text-lg flex items-center" onClick={() => setIsMenuOpen(false)}>
                <Heart className="mr-3 h-5 w-5" /> Wishlist
              </Link>
              <Link to="/cart" className="py-2 text-lg flex items-center" onClick={() => setIsMenuOpen(false)}>
              ...
              <Link to="/account" className="py-2 text-lg flex items-center" onClick={() => setIsMenuOpen(false)}>
